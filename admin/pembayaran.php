...
<div class="pull-right">
      <a href="index.php?halaman=pembelian" class="btn btn-warning btn-xs"> <i class="glyphicon glyphicon-refresh"></i> Kembali</a>
</div>
<?php
...
<div class="row">
      ...
      <div class="col-md-6">
            <img src="../assets/images/bukti_pembayaran/<?= $detail['bukti']; ?>" alt="bukti pembayaran" class="img-responsive">
      </div>
</div>
