...
<head>
    ...
    <title> Admin Trainit Toko</title>
    <!-- CSS Sendiri -->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Iok Store</a>
            </div>
            <div style="color: red;
padding: 15px 50px 5px 50px;
float: right;
font-size: 14px;"> Last access : 30 April 2020 &nbsp; <a href="index.php?halaman=logout" class="btn btn-flat bg-color-red"><i class="fa fa-sign-out "></i> Logout</a> </div>
        </nav>
        <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li class="text-center">
                        <img src="../assets/img/detik.gif" class="user-image img-responsive" />
                    </li>

                    <li> <a href="index.php"><i class="fa fa-dashboard "></i> Home</a> </li>
                    <li> <a href="index.php?halaman=kategori"><i class="fa fa-archive "></i> Kategori</a> </li>
